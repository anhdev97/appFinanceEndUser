package vn.an.finance.admin.web.rest;
...
import vn.an.finance.admin.service.ClientQueryService;
import vn.an.finance.admin.service.ClientService;
import vn.an.finance.admin.service.criteria.ClientCriteria;
import vn.an.finance.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link vn.an.finance.admin.domain.Client}.
 */
@RestController
@RequestMapping("/api")
