package vn.an.finance.admin.service.criteria;
...
/**
 * Criteria class for the {@link vn.an.finance.admin.domain.Client} entity. This class is used
 * in {@link vn.an.finance.admin.web.rest.ClientResource} to receive all the possible filtering options from
